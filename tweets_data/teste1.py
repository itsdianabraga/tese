...
doc=open('C:/Users/diana/PycharmProjects/thesis/queries/queries_kids.json', 'r')
db = json.load(doc)
...
print(len(tweets_extracao))

ficheiro = open("../tweets_obesidade.json", "w", encoding='utf-8')
