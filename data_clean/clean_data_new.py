...
tweets_guardados=open("tweets_db_clean1.json", encoding='utf-8')
tweets_guardados=json.load(tweets_guardados)

tweets_perdidos=open("tweets_perdidos1.json", encoding='utf-8')
tweets_perdidos=json.load(tweets_perdidos)

db1=tweets_guardados
db2=tweets_perdidos
...
for key, value in db.items():
    if key not in tweets_guardados.keys() and key not in tweets_perdidos.keys():
